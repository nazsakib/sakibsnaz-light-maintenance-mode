...
function slmm_display_maintenance_mode()
{
    if (slmm_is_enabled() && !current_user_can('manage_options') && !is_admin()) {
        ...
        <head>
            ...
            <title><?php esc_html_e('Site Under Maintenance', 'sakibsnaz-light-maintenance-mode'); ?></title>
            <style>
                body {
        ...
        <body>
            <div class="container">
                <div class="icon">🚧</div>
                <h1><?php esc_html_e('We’ll Be Right Back!', 'sakibsnaz-light-maintenance-mode'); ?></h1>
                <p><?php esc_html_e('Our site is currently undergoing scheduled maintenance to improve your experience. Please check back soon.', 'sakibsnaz-light-maintenance-mode'); ?>
                </p>
